...
public class StudentLinkedListTest {
	...
	@Test
	public void testSingleElementRemove() {
		DoubleLinkedList<Integer> singleElementList = new DoubleLinkedListImpl<>();

		singleElementList.insert(1);
		Assert.assertArrayEquals(new Integer[] {1}, singleElementList.toArray());

		singleElementList.remove(1);
		System.out.println(Arrays.toString(singleElementList.toArray()));
		Assert.assertArrayEquals(new Integer[0], singleElementList.toArray());

		singleElementList.insert(2);
		Assert.assertArrayEquals(new Integer[] {2}, singleElementList.toArray());
